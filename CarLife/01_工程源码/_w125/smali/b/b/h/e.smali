...
.method public a()V
    ...
    iget-object v5, p0, Lb/b/h/e;->d:Lb/b/h/x0;
    ...
    .line 2
    iget-object v5, p0, Lb/b/h/e;->f:Lb/b/h/x0;
    ...
    iput-object v5, p0, Lb/b/h/e;->f:Lb/b/h/x0;
    ...
    invoke-virtual {v7}, Landroid/view/View;->getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    :cond_3
    instance-of v8, v7, Lb/e/j/p;

    if-eqz v8, :cond_4

    check-cast v7, Lb/e/j/p;

    invoke-interface {v7}, Lb/e/j/p;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .line 6
    iput-boolean v3, v5, Lb/b/h/x0;->d:Z
    ...
    :cond_6
    instance-of v1, v7, Lb/e/j/p;

    if-eqz v1, :cond_7

    check-cast v7, Lb/e/j/p;

    invoke-interface {v7}, Lb/e/j/p;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 8
    iput-boolean v3, v5, Lb/b/h/x0;->c:Z
...
.method public d(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v3, p2, v8}, Lb/b/h/z0;->o(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lb/b/h/z0;
    ...
    :try_start_0
    invoke-virtual {v0, v8}, Lb/b/h/z0;->m(I)Z
    ...
    invoke-virtual {v0, v8, p2}, Lb/b/h/z0;->j(II)I
    ...
    invoke-virtual {p1, v1, v2}, Lb/b/h/j;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    instance-of v4, v1, Lb/e/j/p;

    if-eqz v4, :cond_5

    check-cast v1, Lb/e/j/p;

    invoke-interface {v1, v3}, Lb/e/j/p;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 4
    invoke-virtual {v0, v1}, Lb/b/h/z0;->m(I)Z
    ...
    invoke-virtual {v0, v1, p2}, Lb/b/h/z0;->h(II)I

    move-result p2

    const/4 v1, 0x0

    invoke-static {p2, v1}, Lb/b/h/g0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_9
    instance-of p1, v3, Lb/e/j/p;

    if-eqz p1, :cond_a

    check-cast v3, Lb/e/j/p;

    invoke-interface {v3, p2}, Lb/e/j/p;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method public f(I)V
    ...
    invoke-virtual {v0, v1, p1}, Lb/b/h/j;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
