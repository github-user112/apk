...
public final class MediaMetadataCompat implements android.os.Parcelable {
    ...
    public static final d.e.a<java.lang.String, java.lang.Integer> METADATA_KEYS_TYPE;
    ...
    public static final java.lang.String TAG = "MediaMetadata";
    public final android.os.Bundle mBundle;
    public android.support.v4.media.MediaDescriptionCompat mDescription;
    ...
    public static final class Builder {
        ...
        private android.graphics.Bitmap scaleBitmap(android.graphics.Bitmap bitmap, int i) {
            float f2 = i;
            float fMin = java.lang.Math.min(f2 / bitmap.getWidth(), f2 / bitmap.getHeight());
        ...
        public android.support.v4.media.MediaMetadataCompat.Builder putBitmap(java.lang.String str, android.graphics.Bitmap bitmap) {
            if ((android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.e(str) >= 0) && android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null).intValue() != 2) {
                throw new java.lang.IllegalArgumentException(e.a.c.a.a.f("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public android.support.v4.media.MediaMetadataCompat.Builder putLong(java.lang.String str, long j) {
            if ((android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.e(str) >= 0) && android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null).intValue() != 0) {
                throw new java.lang.IllegalArgumentException(e.a.c.a.a.f("The ", str, " key cannot be used to put a long"));
            }
        ...
        public android.support.v4.media.MediaMetadataCompat.Builder putRating(java.lang.String str, android.support.v4.media.RatingCompat ratingCompat) {
            android.support.v4.media.RatingCompat ratingCompat2;
            android.os.Bundle bundle;
            if ((android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.e(str) >= 0) && android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null).intValue() != 3) {
                throw new java.lang.IllegalArgumentException(e.a.c.a.a.f("The ", str, " key cannot be used to put a Rating"));
            }
            if (android.os.Build.VERSION.SDK_INT >= 19) {
                bundle = this.mBundle;
                ratingCompat2 = (android.os.Parcelable) ratingCompat.getRating();
            } else {
                bundle = this.mBundle;
        ...
        public android.support.v4.media.MediaMetadataCompat.Builder putString(java.lang.String str, java.lang.String str2) {
            if ((android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.e(str) >= 0) && android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null).intValue() != 1) {
                throw new java.lang.IllegalArgumentException(e.a.c.a.a.f("The ", str, " key cannot be used to put a String"));
            }
        ...
        public android.support.v4.media.MediaMetadataCompat.Builder putText(java.lang.String str, java.lang.CharSequence charSequence) {
            if ((android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.e(str) >= 0) && android.support.v4.media.MediaMetadataCompat.METADATA_KEYS_TYPE.getOrDefault(str, null).intValue() != 1) {
                throw new java.lang.IllegalArgumentException(e.a.c.a.a.f("The ", str, " key cannot be used to put a CharSequence"));
            }
    ...
    static {
        d.e.a<java.lang.String, java.lang.Integer> aVar = new d.e.a<>();
    ...
    public android.graphics.Bitmap getBitmap(java.lang.String str) {
        try {
            ...
            android.util.Log.w(TAG, "Failed to retrieve a key as Bitmap.", e2);
            return null;
        }
    }
    ...
    public android.support.v4.media.RatingCompat getRating(java.lang.String str) {
        try {
            return android.os.Build.VERSION.SDK_INT >= 19 ? android.support.v4.media.RatingCompat.fromRating(this.mBundle.getParcelable(str)) : (android.support.v4.media.RatingCompat) this.mBundle.getParcelable(str);
        } catch (java.lang.Exception e2) {
            android.util.Log.w(TAG, "Failed to retrieve a key as Rating.", e2);
            return null;
        }
    }
