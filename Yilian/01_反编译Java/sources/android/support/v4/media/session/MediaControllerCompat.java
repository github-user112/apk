...
public final class MediaControllerCompat {
    ...
    public static final java.lang.String TAG = "MediaControllerCompat";
    public final android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl mImpl;
    public final java.util.HashSet<android.support.v4.media.session.MediaControllerCompat.Callback> mRegisteredCallbacks = new java.util.HashSet<>();
    ...
    public static abstract class Callback implements android.os.IBinder.DeathRecipient {
        ...
        public static class StubApi21 implements android.support.v4.media.session.MediaControllerCompatApi21.Callback {
            public final java.lang.ref.WeakReference<android.support.v4.media.session.MediaControllerCompat.Callback> mCallback;
        ...
        public static class StubCompat extends android.support.v4.media.session.IMediaControllerCallback.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaControllerCallback
            public void onVolumeInfoChanged(android.support.v4.media.session.ParcelableVolumeInfo parcelableVolumeInfo) {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = this.mCallback.get();
                if (callback != null) {
        ...
        public Callback() {
            java.lang.Object objCreateCallback;
            if (android.os.Build.VERSION.SDK_INT >= 21) {
                objCreateCallback = android.support.v4.media.session.MediaControllerCompatApi21.createCallback(new android.support.v4.media.session.MediaControllerCompat.Callback.StubApi21(this));
            } else {
    ...
    public static class MediaControllerExtraData extends d.g.e.e.a {
        public final android.support.v4.media.session.MediaControllerCompat mMediaController;
    ...
    public static class MediaControllerImplApi21 implements android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl {
        ...
        public final java.util.List<android.support.v4.media.session.MediaControllerCompat.Callback> mPendingCallbacks = new java.util.ArrayList();
        public java.util.HashMap<android.support.v4.media.session.MediaControllerCompat.Callback, android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback> mCallbackMap = new java.util.HashMap<>();

        public static class ExtraBinderRequestResultReceiver extends android.os.ResultReceiver {
            public java.lang.ref.WeakReference<android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21> mMediaControllerImpl;
            ...
            public void onReceiveResult(int i, android.os.Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(android.support.v4.media.session.IMediaSession.Stub.asInterface(d.b.k.r.x(bundle, android.support.v4.media.session.MediaSessionCompat.KEY_EXTRA_BINDER)));
        ...
        public android.support.v4.media.session.PlaybackStateCompat getPlaybackState() {
            if (this.mSessionToken.getExtraBinder() != null) {
                try {
                    ...
                    android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getPlaybackState.", e2);
                }
            }
        ...
        public int getRatingType() {
            if (android.os.Build.VERSION.SDK_INT < 22 && this.mSessionToken.getExtraBinder() != null) {
                try {
                    ...
                    android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getRatingType.", e2);
                }
            }
        ...
        public int getRepeatMode() {
            ...
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getRepeatMode.", e2);
                return -1;
            }
        }
        ...
        public int getShuffleMode() {
            ...
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getShuffleMode.", e2);
                return -1;
            }
        }
        ...
        public boolean isCaptioningEnabled() {
            ...
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in isCaptioningEnabled.", e2);
                return false;
            }
        }
        ...
        public void processPendingCallbacksLocked() {
            ...
            for (android.support.v4.media.session.MediaControllerCompat.Callback callback : this.mPendingCallbacks) {
                ...
                try {
                    ...
                    android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in registerCallback.", e2);
                }
            }
            ...
            synchronized (this.mLock) {
                if (this.mSessionToken.getExtraBinder() != null) {
                    try {
                        ...
                        android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in unregisterCallback.", e2);
                    }
                }
    ...
    public static class MediaControllerImplApi23 extends android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21 {
        public MediaControllerImplApi23(android.content.Context context, android.support.v4.media.session.MediaSessionCompat.Token token) {
            super(context, token);
        }
    ...
    public static class MediaControllerImplApi24 extends android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi23 {
        public MediaControllerImplApi24(android.content.Context context, android.support.v4.media.session.MediaSessionCompat.Token token) {
            super(context, token);
        }
    ...
    public static class MediaControllerImplBase implements android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl {
        ...
        public void addQueueItem(android.support.v4.media.MediaDescriptionCompat mediaDescriptionCompat) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in addQueueItem.", e2);
            }
        }
        ...
        public void addQueueItem(android.support.v4.media.MediaDescriptionCompat mediaDescriptionCompat, int i) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in addQueueItemAt.", e2);
            }
        }
        ...
        public void adjustVolume(int i, int i2) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in adjustVolume.", e2);
            }
        }
        ...
        public boolean dispatchMediaButtonEvent(android.view.KeyEvent keyEvent) {
            ...
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in dispatchMediaButtonEvent.", e2);
                return false;
            }
        }
        ...
        public android.os.Bundle getExtras() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getExtras.", e2);
                return null;
            }
        }
        ...
        public long getFlags() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getFlags.", e2);
                return 0L;
            }
        }
        ...
        public android.support.v4.media.MediaMetadataCompat getMetadata() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getMetadata.", e2);
                return null;
            }
        }
        ...
        public java.lang.String getPackageName() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getPackageName.", e2);
                return null;
            }
        }
        ...
        public android.support.v4.media.session.MediaControllerCompat.PlaybackInfo getPlaybackInfo() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getPlaybackInfo.", e2);
                return null;
            }
        }
        ...
        public java.util.List<android.support.v4.media.session.MediaSessionCompat.QueueItem> getQueue() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getQueue.", e2);
                return null;
            }
        }
        ...
        public java.lang.CharSequence getQueueTitle() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getQueueTitle.", e2);
                return null;
            }
        }
        ...
        public android.app.PendingIntent getSessionActivity() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in getSessionActivity.", e2);
                return null;
            }
        }
        ...
        public void removeQueueItem(android.support.v4.media.MediaDescriptionCompat mediaDescriptionCompat) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in removeQueueItem.", e2);
            }
        }
        ...
        public void sendCommand(java.lang.String str, android.os.Bundle bundle, android.os.ResultReceiver resultReceiver) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in sendCommand.", e2);
            }
        }
        ...
        public void setVolumeTo(int i, int i2) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in setVolumeTo.", e2);
            }
        }
    ...
    public static class TransportControlsApi21 extends android.support.v4.media.session.MediaControllerCompat.TransportControls {
        public final java.lang.Object mControlsObj;
    ...
    public static class TransportControlsBase extends android.support.v4.media.session.MediaControllerCompat.TransportControls {
        ...
        public void fastForward() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in fastForward.", e2);
            }
        }
        ...
        public void pause() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in pause.", e2);
            }
        }
        ...
        public void play() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in play.", e2);
            }
        }
        ...
        public void playFromMediaId(java.lang.String str, android.os.Bundle bundle) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in playFromMediaId.", e2);
            }
        }
        ...
        public void playFromSearch(java.lang.String str, android.os.Bundle bundle) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in playFromSearch.", e2);
            }
        }
        ...
        public void playFromUri(android.net.Uri uri, android.os.Bundle bundle) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in playFromUri.", e2);
            }
        }
        ...
        public void prepare() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in prepare.", e2);
            }
        }
        ...
        public void prepareFromMediaId(java.lang.String str, android.os.Bundle bundle) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in prepareFromMediaId.", e2);
            }
        }
        ...
        public void prepareFromSearch(java.lang.String str, android.os.Bundle bundle) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in prepareFromSearch.", e2);
            }
        }
        ...
        public void prepareFromUri(android.net.Uri uri, android.os.Bundle bundle) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in prepareFromUri.", e2);
            }
        }
        ...
        public void rewind() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in rewind.", e2);
            }
        }
        ...
        public void seekTo(long j) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in seekTo.", e2);
            }
        }
        ...
        public void sendCustomAction(java.lang.String str, android.os.Bundle bundle) {
            ...
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in sendCustomAction.", e2);
            }
        }
        ...
        public void setCaptioningEnabled(boolean z) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in setCaptioningEnabled.", e2);
            }
        }
        ...
        public void setRating(android.support.v4.media.RatingCompat ratingCompat) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in setRating.", e2);
            }
        }
        ...
        public void setRepeatMode(int i) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in setRepeatMode.", e2);
            }
        }
        ...
        public void setShuffleMode(int i) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in setShuffleMode.", e2);
            }
        }
        ...
        public void skipToNext() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in skipToNext.", e2);
            }
        }
        ...
        public void skipToPrevious() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in skipToPrevious.", e2);
            }
        }
        ...
        public void skipToQueueItem(long j) {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in skipToQueueItem.", e2);
            }
        }
        ...
        public void stop() {
            try {
                ...
                android.util.Log.e(android.support.v4.media.session.MediaControllerCompat.TAG, "Dead object in stop.", e2);
            }
        }
    }
    ...
    public MediaControllerCompat(android.content.Context context, android.support.v4.media.session.MediaSessionCompat.Token token) {
        ...
        if (i >= 24) {
            mediaControllerImplApi21 = new android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi24(context, token);
        } else if (i >= 23) {
            mediaControllerImplApi21 = new android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi23(context, token);
        } else {
            if (i < 21) {
                this.mImpl = new android.support.v4.media.session.MediaControllerCompat.MediaControllerImplBase(token);
                return;
            }
            mediaControllerImplApi21 = new android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21(context, token);
        }
    ...
    public MediaControllerCompat(android.content.Context context, android.support.v4.media.session.MediaSessionCompat mediaSessionCompat) {
        ...
        try {
            ...
            android.util.Log.w(TAG, "Failed to create MediaControllerImpl.", e2);
        }
    ...
    public static android.support.v4.media.session.MediaControllerCompat getMediaController(android.app.Activity activity) {
        ...
        if (activity instanceof d.g.e.e) {
            android.support.v4.media.session.MediaControllerCompat.MediaControllerExtraData mediaControllerExtraData = (android.support.v4.media.session.MediaControllerCompat.MediaControllerExtraData) ((d.g.e.e) activity).getExtraData(android.support.v4.media.session.MediaControllerCompat.MediaControllerExtraData.class);
        ...
        try {
            ...
            android.util.Log.e(TAG, "Dead object in getMediaController.", e2);
            return null;
        }
    }
    ...
    public static void setMediaController(android.app.Activity activity, android.support.v4.media.session.MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof d.g.e.e) {
            ((d.g.e.e) activity).putExtraData(new android.support.v4.media.session.MediaControllerCompat.MediaControllerExtraData(mediaControllerCompat));
        }
        if (android.os.Build.VERSION.SDK_INT >= 21) {
    ...
    public static void validateCustomAction(java.lang.String str, android.os.Bundle bundle) {
        ...
        if (c2 == 0 || c2 == 1) {
            if (bundle == null || !bundle.containsKey(android.support.v4.media.session.MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new java.lang.IllegalArgumentException(e.a.c.a.a.f("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
