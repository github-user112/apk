...
public final class Ac3Util {
    ...
    public static final int[] SAMPLE_RATE_BY_FSCOD = {48000, com.google.android.exoplayer2.source.SilenceMediaSource.SAMPLE_RATE_HZ, com.google.android.exoplayer2.video.spherical.ProjectionDecoder.MAX_VERTEX_COUNT};
    ...
    public static final int[] BITRATE_BY_HALF_FRMSIZECOD = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, android.support.v4.media.session.MediaSessionCompat.MAX_BITMAP_SIZE_IN_DP, com.google.android.exoplayer2.audio.MpegAudioUtil.SAMPLES_PER_FRAME_L1, 448, 512, com.google.android.exoplayer2.audio.MpegAudioUtil.SAMPLES_PER_FRAME_L3_V2, 640};
    ...
    public static final class SyncFrameInfo {
        ...
        public SyncFrameInfo(java.lang.String str, int i, int i2, int i3, int i4, int i5) {
            this.mimeType = str;
            this.streamType = i;
    ...
    public static com.google.android.exoplayer2.Format parseAc3AnnexFFormat(com.google.android.exoplayer2.util.ParsableByteArray parsableByteArray, java.lang.String str, java.lang.String str2, com.google.android.exoplayer2.drm.DrmInitData drmInitData) {
        ...
        return new com.google.android.exoplayer2.Format.Builder().setId(str).setSampleMimeType(com.google.android.exoplayer2.util.MimeTypes.AUDIO_AC3).setChannelCount(i2).setSampleRate(i).setDrmInitData(drmInitData).setLanguage(str2).build();
    }
    ...
    public static com.google.android.exoplayer2.audio.Ac3Util.SyncFrameInfo parseAc3SyncframeInfo(com.google.android.exoplayer2.util.ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            str = (parsableBitArray.readBit() && parsableBitArray.readBits(i8) == 1 && parsableBitArray.readBits(8) == 1) ? com.google.android.exoplayer2.util.MimeTypes.AUDIO_E_AC3_JOC : com.google.android.exoplayer2.util.MimeTypes.AUDIO_E_AC3;
            i4 = i11;
            i5 = i12;
            i = bits3;
            i2 = i7;
            ...
            java.lang.String str2 = bits8 == 3 ? null : com.google.android.exoplayer2.util.MimeTypes.AUDIO_AC3;
    ...
    public static com.google.android.exoplayer2.Format parseEAc3AnnexFFormat(com.google.android.exoplayer2.util.ParsableByteArray parsableByteArray, java.lang.String str, java.lang.String str2, com.google.android.exoplayer2.drm.DrmInitData drmInitData) {
        ...
        return new com.google.android.exoplayer2.Format.Builder().setId(str).setSampleMimeType((parsableByteArray.bytesLeft() <= 0 || (parsableByteArray.readUnsignedByte() & 1) == 0) ? com.google.android.exoplayer2.util.MimeTypes.AUDIO_E_AC3 : com.google.android.exoplayer2.util.MimeTypes.AUDIO_E_AC3_JOC).setChannelCount(i2).setSampleRate(i).setDrmInitData(drmInitData).setLanguage(str2).build();
    }
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(byte[] bArr) {
        if (bArr[4] == -8 && bArr[5] == 114 && bArr[6] == 111 && (bArr[7] & com.google.android.exoplayer2.audio.DtsUtil.FIRST_BYTE_LE) == 186) {
