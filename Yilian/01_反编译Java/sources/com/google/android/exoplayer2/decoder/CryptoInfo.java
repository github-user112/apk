...
public final class CryptoInfo {
    ...
    public final android.media.MediaCodec.CryptoInfo frameworkCryptoInfo;
    public byte[] iv;
    public byte[] key;
    public int mode;
    ...
    public final com.google.android.exoplayer2.decoder.CryptoInfo.PatternHolderV24 patternHolder;

    public static final class PatternHolderV24 {
        public final android.media.MediaCodec.CryptoInfo frameworkCryptoInfo;
        public final android.media.MediaCodec.CryptoInfo.Pattern pattern;
    ...
    public CryptoInfo() {
        ...
        this.frameworkCryptoInfo = cryptoInfo;
        this.patternHolder = com.google.android.exoplayer2.util.Util.SDK_INT >= 24 ? new com.google.android.exoplayer2.decoder.CryptoInfo.PatternHolderV24(cryptoInfo) : null;
    }
    ...
    public void set(int i, int[] iArr, int[] iArr2, byte[] bArr, byte[] bArr2, int i2, int i3, int i4) {
        ...
        if (com.google.android.exoplayer2.util.Util.SDK_INT >= 24) {
            ((com.google.android.exoplayer2.decoder.CryptoInfo.PatternHolderV24) com.google.android.exoplayer2.util.Assertions.checkNotNull(this.patternHolder)).set(i3, i4);
        }
    }
}
