...
public final class Sniffer {
    ...
    public final com.google.android.exoplayer2.util.ParsableByteArray scratch = new com.google.android.exoplayer2.util.ParsableByteArray(8);

    private long readUint(com.google.android.exoplayer2.extractor.ExtractorInput extractorInput) {
        int i = 0;
    ...
    public boolean sniff(com.google.android.exoplayer2.extractor.ExtractorInput extractorInput) {
        ...
        if (length != -1 && length <= android.support.v4.media.session.PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) {
            j = length;
        }
        int i = (int) j;
