...
public abstract class Atom {
    ...
    public static final class ContainerAtom extends com.google.android.exoplayer2.extractor.mp4.Atom {
        ...
        public com.google.android.exoplayer2.extractor.mp4.Atom.ContainerAtom getContainerAtomOfType(int i) {
        ...
        public com.google.android.exoplayer2.extractor.mp4.Atom.LeafAtom getLeafAtomOfType(int i) {
            int size = this.leafChildren.size();
            for (int i2 = 0; i2 < size; i2++) {
        ...
        public java.lang.String toString() {
            java.lang.String atomTypeString = com.google.android.exoplayer2.extractor.mp4.Atom.getAtomTypeString(this.type);
            java.lang.String string = java.util.Arrays.toString(this.leafChildren.toArray());
            java.lang.String string2 = java.util.Arrays.toString(this.containerChildren.toArray());
            java.lang.StringBuilder sbL = e.a.c.a.a.l(e.a.c.a.a.m(string2, e.a.c.a.a.m(string, e.a.c.a.a.m(atomTypeString, 22))), atomTypeString, " leaves: ", string, " containers: ");
            sbL.append(string2);
            return sbL.toString();
        }
    }
