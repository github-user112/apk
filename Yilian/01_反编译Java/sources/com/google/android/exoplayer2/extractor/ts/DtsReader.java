...
public final class DtsReader implements com.google.android.exoplayer2.extractor.ts.ElementaryStreamReader {
    ...
    public final com.google.android.exoplayer2.util.ParsableByteArray headerScratchBytes = new com.google.android.exoplayer2.util.ParsableByteArray(new byte[18]);
    public int state = 0;
    public long timeUs = com.google.android.exoplayer2.C.TIME_UNSET;
    ...
    private void parseHeader() {
        ...
        if (this.format == null) {
            com.google.android.exoplayer2.Format dtsFormat = com.google.android.exoplayer2.audio.DtsUtil.parseDtsFormat(data, this.formatId, this.language, null);
    ...
    private boolean skipToNextSync(com.google.android.exoplayer2.util.ParsableByteArray parsableByteArray) {
        while (parsableByteArray.bytesLeft() > 0) {
            ...
            if (com.google.android.exoplayer2.audio.DtsUtil.isSyncWord(unsignedByte)) {
                byte[] data = this.headerScratchBytes.getData();
