...
public final class SpliceInsertCommand extends com.google.android.exoplayer2.metadata.scte35.SpliceCommand {
    ...
    public SpliceInsertCommand(long j, boolean z, boolean z2, boolean z3, boolean z4, long j2, long j3, java.util.List<com.google.android.exoplayer2.metadata.scte35.SpliceInsertCommand.ComponentSplice> list, boolean z5, long j4, int i, int i2, int i3) {
    ...
    public static com.google.android.exoplayer2.metadata.scte35.SpliceInsertCommand parseFromSection(com.google.android.exoplayer2.util.ParsableByteArray parsableByteArray, long j, com.google.android.exoplayer2.util.TimestampAdjuster timestampAdjuster) {
        ...
        if (z6) {
            ...
            long spliceTime = (!z8 || z10) ? com.google.android.exoplayer2.C.TIME_UNSET : com.google.android.exoplayer2.metadata.scte35.TimeSignalCommand.parseSpliceTime(parsableByteArray, j);
            if (!z8) {
                int unsignedByte4 = parsableByteArray.readUnsignedByte();
                java.util.ArrayList arrayList = new java.util.ArrayList(unsignedByte4);
                for (int i = 0; i < unsignedByte4; i++) {
                    int unsignedByte5 = parsableByteArray.readUnsignedByte();
                    long spliceTime2 = !z10 ? com.google.android.exoplayer2.metadata.scte35.TimeSignalCommand.parseSpliceTime(parsableByteArray, j) : com.google.android.exoplayer2.C.TIME_UNSET;
            ...
            if (z9) {
                ...
                z5 = false;
                unsignedInt = com.google.android.exoplayer2.C.TIME_UNSET;
            }
        ...
        return new com.google.android.exoplayer2.metadata.scte35.SpliceInsertCommand(unsignedInt2, z6, z, z4, z2, j2, timestampAdjuster.adjustTsTimestamp(j2), list, z3, j3, unsignedShort, unsignedByte, unsignedByte2);
    }
