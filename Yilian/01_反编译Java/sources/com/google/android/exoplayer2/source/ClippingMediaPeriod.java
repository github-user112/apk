...
public final class ClippingMediaPeriod implements com.google.android.exoplayer2.source.MediaPeriod, com.google.android.exoplayer2.source.MediaPeriod.Callback {
    ...
    public com.google.android.exoplayer2.source.ClippingMediaPeriod.ClippingSampleStream[] sampleStreams = new com.google.android.exoplayer2.source.ClippingMediaPeriod.ClippingSampleStream[0];
    public long startUs;
    ...
    public final class ClippingSampleStream implements com.google.android.exoplayer2.source.SampleStream {
        ...
        public int readData(com.google.android.exoplayer2.FormatHolder formatHolder, com.google.android.exoplayer2.decoder.DecoderInputBuffer decoderInputBuffer, int i) {
            ...
            long j = com.google.android.exoplayer2.source.ClippingMediaPeriod.this.endUs;
            if (j == Long.MIN_VALUE || ((data != -4 || decoderInputBuffer.timeUs < j) && !(data == -3 && com.google.android.exoplayer2.source.ClippingMediaPeriod.this.getBufferedPositionUs() == Long.MIN_VALUE && !decoderInputBuffer.waitingForKeys))) {
                return data;
            }
    ...
    public ClippingMediaPeriod(com.google.android.exoplayer2.source.MediaPeriod mediaPeriod, boolean z, long j, long j2) {
        ...
        this.pendingInitialDiscontinuityPositionUs = z ? j : com.google.android.exoplayer2.C.TIME_UNSET;
        this.startUs = j;
        this.endUs = j2;
    }
    ...
    private com.google.android.exoplayer2.SeekParameters clipSeekParameters(long j, com.google.android.exoplayer2.SeekParameters seekParameters) {
        long jConstrainValue = com.google.android.exoplayer2.util.Util.constrainValue(seekParameters.toleranceBeforeUs, 0L, j - this.startUs);
        long j2 = seekParameters.toleranceAfterUs;
        long j3 = this.endUs;
        long jConstrainValue2 = com.google.android.exoplayer2.util.Util.constrainValue(j2, 0L, j3 == Long.MIN_VALUE ? Long.MAX_VALUE : j3 - j);
    ...
    public static boolean shouldKeepInitialDiscontinuity(long j, com.google.android.exoplayer2.trackselection.ExoTrackSelection[] exoTrackSelectionArr) {
        if (j != 0) {
    ...
    public boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != com.google.android.exoplayer2.C.TIME_UNSET;
    }

    @Override // com.google.android.exoplayer2.source.MediaPeriod
    public void maybeThrowPrepareError() throws com.google.android.exoplayer2.source.ClippingMediaSource.IllegalClippingException {
    ...
    public long readDiscontinuity() {
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = com.google.android.exoplayer2.C.TIME_UNSET;
            long discontinuity = readDiscontinuity();
            return discontinuity != com.google.android.exoplayer2.C.TIME_UNSET ? discontinuity : j;
        }
        long discontinuity2 = this.mediaPeriod.readDiscontinuity();
        if (discontinuity2 == com.google.android.exoplayer2.C.TIME_UNSET) {
