...
public final class HlsSampleStream implements com.google.android.exoplayer2.source.SampleStream {
    public int sampleQueueIndex = -1;
    public final com.google.android.exoplayer2.source.hls.HlsSampleStreamWrapper sampleStreamWrapper;
    ...
    @Override // com.google.android.exoplayer2.source.SampleStream
    public void maybeThrowError() throws com.google.android.exoplayer2.source.hls.SampleQueueMappingException {
        int i = this.sampleQueueIndex;
        if (i == -2) {
