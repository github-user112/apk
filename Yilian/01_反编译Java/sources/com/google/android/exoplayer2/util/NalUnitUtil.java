...
public final class NalUnitUtil {
    ...
    public static final java.lang.String TAG = "NalUnitUtil";
    public static final byte[] NAL_START_CODE = {0, 0, 0, 1};
    public static final float[] ASPECT_RATIO_IDC_VALUES = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};
    public static final java.lang.Object scratchEscapePositionsLock = new java.lang.Object();
    ...
    public static int findNalUnit(byte[] bArr, int i, int i2, boolean[] zArr) {
        ...
        int i5 = i + 2;
        while (i5 < i4) {
            if ((bArr[i5] & com.google.android.exoplayer2.audio.DtsUtil.FIRST_BYTE_LE) == 0) {
                int i6 = i5 - 2;
    ...
    public static boolean isNalUnitSei(java.lang.String str, byte b) {
        if (com.google.android.exoplayer2.util.MimeTypes.VIDEO_H264.equals(str) && (b & 31) == 6) {
            return true;
        }
        return com.google.android.exoplayer2.util.MimeTypes.VIDEO_H265.equals(str) && ((b & 126) >> 1) == 39;
    }
    ...
    public static com.google.android.exoplayer2.util.NalUnitUtil.H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        int i8 = parsableNalUnitBitArray.readBit() ? 0 : bits;
        while (true) {
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
            parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
        ...
        return new com.google.android.exoplayer2.util.NalUnitUtil.H265SpsData(bits2, bit, bits3, i3, iArr, bits4, unsignedExpGolombCodedInt, unsignedExpGolombCodedInt3, unsignedExpGolombCodedInt4, f2);
    }
    ...
    */
    public static com.google.android.exoplayer2.util.NalUnitUtil.SpsData parseSpsNalUnitPayload(byte[] r20, int r21, int r22) {
        /*
    ...
    public static void skipH265ScalingList(com.google.android.exoplayer2.util.ParsableNalUnitBitArray parsableNalUnitBitArray) {
        for (int i = 0; i < 4; i++) {
            int i2 = 0;
            while (i2 < 6) {
                int i3 = 1;
    ...
    public static void skipScalingList(com.google.android.exoplayer2.util.ParsableNalUnitBitArray parsableNalUnitBitArray, int i) {
    ...
    public static void skipShortTermReferencePictureSets(com.google.android.exoplayer2.util.ParsableNalUnitBitArray parsableNalUnitBitArray) {
        int unsignedExpGolombCodedInt = parsableNalUnitBitArray.readUnsignedExpGolombCodedInt();
        boolean bit = false;
        int i = 0;
