...
public class c extends com.huawei.hms.framework.network.grs.b.a {
    ...
    public int a(java.lang.String str) throws org.json.JSONException {
        ...
        try {
            org.json.JSONObject jSONObject = new org.json.JSONObject(str).getJSONObject(com.google.android.exoplayer2.util.MimeTypes.BASE_TYPE_APPLICATION);
            ...
            com.huawei.hms.framework.common.Logger.w("LocalManagerV1", "parse appbean failed maybe json style is wrong.", e2);
            return -1;
        }
    }
