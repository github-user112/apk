...
public class d extends com.huawei.hms.framework.network.grs.b.a {
    public d(android.content.Context context, boolean z) {
        ...
        com.huawei.hms.framework.common.Logger.i("LocalManagerV2", "appConfigName is" + appConfigName);
        if (a(android.text.TextUtils.isEmpty(appConfigName) ? "grs_app_global_route_config.json" : appConfigName, context, true) == 0) {
            this.f298d = true;
        }
    }

    @Override // com.huawei.hms.framework.network.grs.b.a
    public int a(java.lang.String str) throws org.json.JSONException {
        ...
        try {
            ...
            com.huawei.hms.framework.common.Logger.w("LocalManagerV2", "parse appbean failed maybe json style is wrong.", e2);
            return -1;
        }
    }
