...
public class MLException extends java.lang.Exception {
    ...
    public MLException(java.lang.String str, int i) {
        super(str);
        this.code = i;
    }

    public MLException(java.lang.String str, int i, java.lang.Throwable th) {
        super(str, th);
        this.code = i;
    }
