    ...
    */
    public static java.lang.String a(int r0, java.lang.String r1) {
        ...
        L24:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.scankit.p.A.a(int, java.lang.String):java.lang.String");
    }
    ...
    public static java.lang.String a(android.content.Context context) {
        ...
        if (context == null || context.getPackageManager().checkPermission("android.permission.ACCESS_NETWORK_STATE", context.getPackageName()) != 0) {
            com.huawei.hms.scankit.p.T.c("hmsSdk", "not have network state phone permission!");
            return "";
        }
        ...
        if (activeNetworkInfo.getType() != 0) {
            ...
            com.huawei.hms.scankit.p.T.c("hmsSdk", "type name = COMPANION_PROXY");
            return "COMPANION_PROXY";
        }
        java.lang.String subtypeName = activeNetworkInfo.getSubtypeName();
        com.huawei.hms.scankit.p.T.b("hmsSdk", "Network getSubtypeName : " + subtypeName);
