...
public final class CompareUtils {
    public static <T extends java.lang.Comparable<T>> int aArrCompare(T[] tArr, T[] tArr2) {
    ...
    public static <T> int aArrCompare(T[] tArr, T[] tArr2, java.util.Comparator<T> comparator) {
        int length = tArr.length;
        int length2 = tArr2.length;
        if (length < length2) {
            return -1;
