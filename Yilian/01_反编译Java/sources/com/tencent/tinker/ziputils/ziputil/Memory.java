...
public final class Memory {
    public static int peekInt(byte[] bArr, int i, java.nio.ByteOrder byteOrder) {
        int i2;
        int i3;
    ...
    public static long peekLong(byte[] bArr, int i, java.nio.ByteOrder byteOrder) {
        if (byteOrder == java.nio.ByteOrder.BIG_ENDIAN) {
            int i2 = i + 1;
            int i3 = i2 + 1;
    ...
    public static short peekShort(byte[] bArr, int i, java.nio.ByteOrder byteOrder) {
        int i2;
        byte b;
        if (byteOrder == java.nio.ByteOrder.BIG_ENDIAN) {
            i2 = bArr[i] << 8;
    ...
    public static void pokeInt(byte[] bArr, int i, int i2, java.nio.ByteOrder byteOrder) {
        if (byteOrder == java.nio.ByteOrder.BIG_ENDIAN) {
            int i3 = i + 1;
    ...
    public static void pokeLong(byte[] bArr, int i, long j, java.nio.ByteOrder byteOrder) {
        if (byteOrder == java.nio.ByteOrder.BIG_ENDIAN) {
            int i2 = (int) (j >> 32);
            int i3 = i + 1;
            bArr[i] = (byte) ((i2 >> 24) & 255);
    ...
    public static void pokeShort(byte[] bArr, int i, short s, java.nio.ByteOrder byteOrder) {
        if (byteOrder == java.nio.ByteOrder.BIG_ENDIAN) {
            bArr[i] = (byte) ((s >> 8) & 255);
