...
public class f<K, V> {
    public final java.util.LinkedHashMap<K, V> a;
    public int b;
    ...
    */
    public void c(int r3) {
        ...
        L1e:
            ...
            int r0 = r2.f1899e     // Catch: java.lang.Throwable -> L69
            int r0 = r0 + 1
            r2.f1899e = r0     // Catch: java.lang.Throwable -> L69
        ...
        L6d:
            goto L6c
        */
        throw new UnsupportedOperationException("Method not decompiled: d.e.f.c(int):void");
    }

    public final synchronized java.lang.String toString() {
        int i;
        i = this.f1900f + this.f1901g;
        return java.lang.String.format(java.util.Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", java.lang.Integer.valueOf(this.f1897c), java.lang.Integer.valueOf(this.f1900f), java.lang.Integer.valueOf(this.f1901g), java.lang.Integer.valueOf(i != 0 ? (this.f1900f * 100) / i : 0));
    }
}
