...
public class d implements d.o.a {
    public final java.lang.reflect.Constructor<?> a;

    public d(java.lang.Class<?> cls) throws java.lang.NoSuchMethodException, java.lang.SecurityException {
    ...
    public java.lang.Object a(java.io.File file, dalvik.system.DexFile dexFile) {
        return this.a.newInstance(file, java.lang.Boolean.FALSE, file, dexFile);
    }
}
