...
public class Announcer extends javax.jmdns.impl.tasks.state.DNSStateTask {
    public static javax.jmdns.JmDNSLogger jmDNSLogger;
    public static java.util.logging.Logger logger;

    static {
        java.util.logging.Logger logger2 = java.util.logging.Logger.getLogger(javax.jmdns.impl.tasks.state.Announcer.class.getName());
        logger = logger2;
        jmDNSLogger = javax.jmdns.JmDNSLogger.getJmDNSLogger(logger2);
    }

    public Announcer(javax.jmdns.impl.JmDNSImpl jmDNSImpl) {
        super(jmDNSImpl, javax.jmdns.impl.tasks.state.DNSStateTask.defaultTTL());
        javax.jmdns.impl.constants.DNSState dNSState = javax.jmdns.impl.constants.DNSState.ANNOUNCING_1;
    ...
    public java.lang.String getName() {
        return e.a.c.a.a.j(e.a.c.a.a.o("Announcer("), getDns() != null ? getDns().getName() : "", ")");
    }
