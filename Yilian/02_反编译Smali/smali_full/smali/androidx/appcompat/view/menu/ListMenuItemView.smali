...
# interfaces
.implements Ld/b/p/i/n$a;
.implements Landroid/widget/AbsListView$SelectionBoundsAdjuster;


# instance fields
.field public a:Ld/b/p/i/i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Ld/b/a;->listMenuViewStyle:I
    ...
    sget-object v2, Ld/b/j;->MenuView:[I

    const/4 v3, 0x0

    invoke-static {v1, p2, v2, v0, v3}, Ld/b/q/v0;->o(Landroid/content/Context;Landroid/util/AttributeSet;[III)Ld/b/q/v0;

    move-result-object p2

    sget v0, Ld/b/j;->MenuView_android_itemBackground:I

    invoke-virtual {p2, v0}, Ld/b/q/v0;->e(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->j:Landroid/graphics/drawable/Drawable;

    sget v0, Ld/b/j;->MenuView_android_itemTextAppearance:I

    const/4 v1, -0x1

    invoke-virtual {p2, v0, v1}, Ld/b/q/v0;->j(II)I

    move-result v0

    iput v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->k:I

    sget v0, Ld/b/j;->MenuView_preserveIconSpacing:I

    invoke-virtual {p2, v0, v3}, Ld/b/q/v0;->a(IZ)Z
    ...
    sget v0, Ld/b/j;->MenuView_subMenuArrow:I
    ...
    sget v1, Ld/b/a;->dropDownListViewStyle:I
    ...
    .line 2
    iget-object p2, p2, Ld/b/q/v0;->b:Landroid/content/res/TypedArray;
...
.method public final a()V
    ...
    sget v1, Ld/b/g;->abc_list_menu_item_checkbox:I
...
.method public final b()V
    ...
    sget v1, Ld/b/g;->abc_list_menu_item_radio:I
...
.method public c(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ld/b/p/i/i;

    invoke-virtual {p1}, Ld/b/p/i/i;->m()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ld/b/p/i/i;

    .line 1
    invoke-virtual {v2}, Ld/b/p/i/i;->e()C
    ...
    :cond_1
    iget-object v4, v2, Ld/b/p/i/i;->n:Ld/b/p/i/g;

    .line 2
    iget-object v4, v4, Ld/b/p/i/g;->a:Landroid/content/Context;
    ...
    iget-object v6, v2, Ld/b/p/i/i;->n:Ld/b/p/i/g;

    .line 4
    iget-object v6, v6, Ld/b/p/i/g;->a:Landroid/content/Context;
    ...
    sget v6, Ld/b/h;->abc_prepend_shortcut_label:I
    ...
    invoke-virtual {v6}, Ld/b/p/i/g;->n()Z

    move-result v6

    if-eqz v6, :cond_3

    iget v2, v2, Ld/b/p/i/i;->k:I

    goto :goto_1

    :cond_3
    iget v2, v2, Ld/b/p/i/i;->i:I

    :goto_1
    const/high16 v6, 0x10000

    sget v7, Ld/b/h;->abc_menu_meta_shortcut_label:I

    invoke-virtual {v4, v7}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v2, v6, v7}, Ld/b/p/i/i;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/16 v6, 0x1000

    sget v7, Ld/b/h;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v7, Ld/b/h;->abc_menu_alt_shortcut_label:I
    ...
    sget v7, Ld/b/h;->abc_menu_shift_shortcut_label:I
    ...
    sget v7, Ld/b/h;->abc_menu_sym_shortcut_label:I
    ...
    sget v6, Ld/b/h;->abc_menu_function_shortcut_label:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v5, v2, v0, v6}, Ld/b/p/i/i;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_4
    sget v0, Ld/b/h;->abc_menu_space_shortcut_label:I

    goto :goto_2

    :cond_5
    sget v0, Ld/b/h;->abc_menu_enter_shortcut_label:I

    goto :goto_2

    :cond_6
    sget v0, Ld/b/h;->abc_menu_delete_shortcut_label:I
...
.method public e(Ld/b/p/i/i;I)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ld/b/p/i/i;

    invoke-virtual {p1}, Ld/b/p/i/i;->isVisible()Z
    ...
    .line 1
    invoke-interface {p0}, Ld/b/p/i/n$a;->d()Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-virtual {p1}, Ld/b/p/i/i;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    .line 2
    :cond_1
    iget-object p2, p1, Ld/b/p/i/i;->e:Ljava/lang/CharSequence;

    .line 3
    :goto_1
    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Ld/b/p/i/i;->isCheckable()Z
    ...
    invoke-virtual {p1}, Ld/b/p/i/i;->e()C

    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/ListMenuItemView;->c(Z)V

    invoke-virtual {p1}, Ld/b/p/i/i;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    iget-object p1, p1, Ld/b/p/i/i;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Ld/b/p/i/i;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->a:Ld/b/p/i/i;
...
.method public onFinishInflate()V
    ...
    invoke-static {p0, v0}, Ld/g/m/s;->M(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    sget v0, Ld/b/f;->title:I
    ...
    :cond_1
    sget v0, Ld/b/f;->group_divider:I
...
.method public setCheckable(Z)V
    ...
    invoke-virtual {v0}, Ld/b/p/i/i;->h()Z
    ...
    invoke-virtual {p1}, Ld/b/p/i/i;->isChecked()Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    iget-object v0, v0, Ld/b/p/i/i;->n:Ld/b/p/i/g;

    .line 2
    iget-boolean v0, v0, Ld/b/p/i/g;->s:Z
    ...
    sget v3, Ld/b/g;->abc_list_menu_item_icon:I
