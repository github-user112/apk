...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/graphics/Rect;
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->G:Landroid/text/TextPaint;
    ...
    sget-object v3, Ld/b/j;->SwitchCompat:[I

    .line 2
    new-instance v5, Ld/b/q/v0;

    invoke-virtual {p1, p2, v3, v0, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v3

    invoke-direct {v5, p1, v3}, Ld/b/q/v0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    .line 3
    sget v3, Ld/b/j;->SwitchCompat_android_thumb:I

    invoke-virtual {v5, v3}, Ld/b/q/v0;->e(I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget v3, Ld/b/j;->SwitchCompat_track:I

    invoke-virtual {v5, v3}, Ld/b/q/v0;->e(I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->f:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget v3, Ld/b/j;->SwitchCompat_android_textOn:I

    invoke-virtual {v5, v3}, Ld/b/q/v0;->l(I)Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->o:Ljava/lang/CharSequence;

    sget v3, Ld/b/j;->SwitchCompat_android_textOff:I

    invoke-virtual {v5, v3}, Ld/b/q/v0;->l(I)Ljava/lang/CharSequence;

    move-result-object v3

    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->p:Ljava/lang/CharSequence;

    sget v3, Ld/b/j;->SwitchCompat_showText:I

    invoke-virtual {v5, v3, v4}, Ld/b/q/v0;->a(IZ)Z

    move-result v3

    iput-boolean v3, p0, Landroidx/appcompat/widget/SwitchCompat;->q:Z

    sget v3, Ld/b/j;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v5, v3, v2}, Ld/b/q/v0;->d(II)I

    move-result v3

    iput v3, p0, Landroidx/appcompat/widget/SwitchCompat;->k:I

    sget v3, Ld/b/j;->SwitchCompat_switchMinWidth:I
    ...
    sget v3, Ld/b/j;->SwitchCompat_switchPadding:I
    ...
    sget v3, Ld/b/j;->SwitchCompat_splitTrack:I

    invoke-virtual {v5, v3, v2}, Ld/b/q/v0;->a(IZ)Z

    move-result v3

    iput-boolean v3, p0, Landroidx/appcompat/widget/SwitchCompat;->n:Z

    sget v3, Ld/b/j;->SwitchCompat_thumbTint:I

    invoke-virtual {v5, v3}, Ld/b/q/v0;->b(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget v3, Ld/b/j;->SwitchCompat_thumbTintMode:I

    const/4 v6, -0x1

    invoke-virtual {v5, v3, v6}, Ld/b/q/v0;->h(II)I

    move-result v3

    invoke-static {v3, v1}, Ld/b/q/c0;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget v3, Ld/b/j;->SwitchCompat_trackTint:I
    ...
    :cond_6
    sget v3, Ld/b/j;->SwitchCompat_trackTintMode:I
    ...
    :cond_9
    sget v3, Ld/b/j;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v5, v3, v2}, Ld/b/q/v0;->j(II)I
    ...
    .line 4
    sget-object v7, Ld/b/j;->TextAppearance:[I
    ...
    .line 6
    sget v7, Ld/b/j;->TextAppearance_android_textColor:I
    ...
    invoke-static {p1, v8}, Ld/b/l/a/a;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iput-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->H:Landroid/content/res/ColorStateList;

    sget v7, Ld/b/j;->TextAppearance_android_textSize:I
    ...
    :cond_c
    sget v7, Ld/b/j;->TextAppearance_android_typeface:I
    ...
    .line 12
    sget v8, Ld/b/j;->TextAppearance_android_textStyle:I
    ...
    .line 16
    :goto_6
    sget v4, Ld/b/j;->TextAppearance_textAllCaps:I
    ...
    .line 18
    new-instance v1, Ld/b/o/a;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Ld/b/o/a;-><init>(Landroid/content/Context;)V

    :cond_15
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/text/method/TransformationMethod;
    ...
    .line 20
    :cond_16
    new-instance v1, Ld/b/q/w;

    invoke-direct {v1, p0}, Ld/b/q/w;-><init>(Landroid/widget/TextView;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->M:Ld/b/q/w;

    invoke-virtual {v1, p2, v0}, Ld/b/q/w;->e(Landroid/util/AttributeSet;I)V

    .line 21
    iget-object p2, v5, Ld/b/q/v0;->b:Landroid/content/res/TypedArray;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Ld/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Ld/b/q/c0;->c:Landroid/graphics/Rect;
...
.method public final a()V
    ...
    invoke-static {v0}, Ld/b/k/r;->A0(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1}, Ld/b/k/r;->u0(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Ld/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Ld/b/q/c0;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v2, v5, v4}, Ld/b/k/r;->m0(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Ld/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Ld/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
