...
# instance fields
.field public a:Ld/b/p/i/g;

.field public b:Ld/b/p/i/i;
...
.method public c(Landroid/content/Context;Ld/b/p/i/g;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->a:Ld/b/p/i/g;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Ld/b/p/i/i;

    if-eqz v0, :cond_0

    invoke-virtual {p1, v0}, Ld/b/p/i/g;->d(Ld/b/p/i/i;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->a:Ld/b/p/i/g;
...
.method public f(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Ld/b/p/i/i;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->a:Ld/b/p/i/g;

    invoke-virtual {v2, v1}, Ld/b/p/i/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Ld/b/p/i/i;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->i(Ld/b/p/i/g;Ld/b/p/i/i;)Z
...
.method public i(Ld/b/p/i/g;Ld/b/p/i/i;)Z
    ...
    instance-of v0, p1, Ld/b/p/b;

    if-eqz v0, :cond_0

    check-cast p1, Ld/b/p/b;

    invoke-interface {p1}, Ld/b/p/b;->f()V
    ...
    .line 2
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Ld/b/p/i/i;
    ...
    .line 3
    iput-boolean p1, p2, Ld/b/p/i/i;->C:Z

    iget-object p2, p2, Ld/b/p/i/i;->n:Ld/b/p/i/g;

    invoke-virtual {p2, p1}, Ld/b/p/i/g;->q(Z)V
...
.method public j(Ld/b/p/i/g;Ld/b/p/i/i;)Z
    ...
    invoke-virtual {p2}, Ld/b/p/i/i;->getActionView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->i:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Ld/b/p/i/i;
    ...
    invoke-virtual {p2, v0}, Ld/b/p/i/g;->q(Z)V
    ...
    instance-of v0, p2, Ld/b/p/b;

    if-eqz v0, :cond_6

    check-cast p2, Ld/b/p/b;

    invoke-interface {p2}, Ld/b/p/b;->c()V
